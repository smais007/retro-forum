...
const allPosts = async () => {
  ...
  posts.forEach((post) => {
    ...
    const discussionPostsTemplate = `<div
    class="flex gap-6 bg-[#F3F3F5] rounded-3xl lg:w-[48.25rem] lg:h-[16.875rem] pt-10  lg:pl-10 pb-11  mb-6 flex-col lg:flex-row">
    <div class="flex justify-center lg:block">
        <div
            class="relative w-[120px] h-[120px] lg:w-[75px] lg:h-[75px] flex justify-center items-center ">
            <img src="${post.image}" alt=""
                class="w-[120px] lg:w-[72px] lg:h-[72px] rounded-full lg:rounded-2xl">
    ...
    <div class="pl-5">
        ...
        <div>
            ...
            <p class="inter p-color text-base lg:w-[35.563rem] leading-6 pb-5">${
              post.description
            }</p>
...
const latestPost = async () => {
  ...
  data.forEach((post) => {
    // console.log(post);
    const poastCard = `<div class="lg:w-[23.375rem] lg:h-[30.125rem] border rounded-3xl p-6">
    <div class=" lg:w-[20.375rem] lg:h-[11.875rem] bg-[#12132D0D] rounded-[20px]">
        <img class="lg:w-[20.375rem] lg:h-[11.875rem] rounded-[20px]"
    ...
    <div class="flex items-center gap-4 pt-4">
        <img class="w-[44px] h-[44px] rounded-[50px]" src="${
          post.profile_image
        }" alt="">
        <div>
